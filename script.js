const commands = [
  ...
  { command: "/t report", source: "ThyToxicBot", access: "Everyone", platform: ["Discord"], status: "Active", category: "Tickets", description: "Creates a private Report a User ticket that only the reporter and authorized staff can view; the closed transcript is archived in the Appeals & Tickets Center.", usage: "/t report user:<member> reason:<what happened> [evidence]" },
  { command: "/t info commands", source: "ThyToxicBot", access: "Everyone", platform: ["Discord"], status: "Active", category: "Information", description: "Opens the complete ThyToxicGamer Command Directory.", usage: "/t info commands" },
  { command: "/t info bot", source: "ThyToxicBot", access: "Everyone", platform: ["Discord"], status: "Active", category: "Information", description: "Checks whether ThyToxicBot is online and responding.", usage: "/t info bot" },
  { command: "/t info server", source: "ThyToxicBot", access: "Everyone", platform: ["Discord"], status: "Active", category: "Information", description: "Shows server details, member presence, creation date, icon, and banner.", usage: "/t info server" },
  { command: "/t info membercount", source: "ThyToxicBot", access: "Everyone", platform: ["Discord"], status: "Active", category: "Information", description: "Shows the server's current member count.", usage: "/t info membercount" },
  { command: "/t info user", source: "ThyToxicBot", access: "Everyone", platform: ["Discord"], status: "Active", category: "Information", description: "Shows account, join-date, role-count, and account-type information for a member.", usage: "/t info user [member]" },
  { command: "/t info avatar", source: "ThyToxicBot", access: "Everyone", platform: ["Discord"], status: "Active", category: "Information", description: "Displays a member's server or Discord avatar.", usage: "/t info avatar [member]" },
  { command: "/t info banner", source: "ThyToxicBot", access: "Everyone", platform: ["Discord"], status: "Active", category: "Information", description: "Displays a member's Discord profile banner when available.", usage: "/t info banner [member]" },
  ...
  { command: "/tstaff blockuser", source: "ThyToxicBot", access: "Admin", platform: ["Discord"], status: "Active", category: "Submission Access", description: "Blocks a member from creating new appeals, reports, and support tickets while preserving existing cases and records. Sends a private Request Block Review button.", usage: "/tstaff blockuser user:<member> reason:<reason>" },
  { command: "/tstaff unblockuser", source: "ThyToxicBot", access: "Admin", platform: ["Discord"], status: "Active", category: "Submission Access", description: "Restores a member's submission access, records the reason, closes any active block review, and notifies the member privately.", usage: "/tstaff unblockuser user:<member> reason:<reason>" },
  { command: "/tstaff blockreply", source: "ThyToxicBot", access: "Moderator", platform: ["Discord"], status: "Active", category: "Submission Access", description: "Replies privately to a blocked member through the protected block-review conversation. The review number is optional inside its matching thread.", usage: "/tstaff blockreply message:<private reply> [review_number]" },
  { command: "/tstaff blockreviewclose", source: "ThyToxicBot", access: "Moderator", platform: ["Discord"], status: "Active", category: "Submission Access", description: "Closes and archives a submission-block review with a required resolution. Closing a review does not itself remove the block.", usage: "/tstaff blockreviewclose resolution:<final result> [review_number]" },
