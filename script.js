const commands = [
  ...
  { command: "/t report", source: "ThyToxicBot", access: "Everyone", platform: ["Discord"], status: "Active", category: "Reports", description: "Privately sends a member report, reason, and optional evidence to the moderation team.", usage: "/t report user:<member> reason:<what happened> [evidence]" },
